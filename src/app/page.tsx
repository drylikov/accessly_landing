          ...
          >
            ...
            >
              <Button size="lg" className="group" asChild>
                <a href="https://github.com/drylikov/accessly/releases/download/v1.0.0/echovault-1.0.0-setup.exe" target="_blank" rel="noopener noreferrer">
              ...
              <Button variant="outline" size="lg" className="group" asChild>
                <a href="https://github.com/drylikov/accessly?tab=readme-ov-file" target="_blank" rel="noopener noreferrer">
              ...
              >
                <Card className="h-full">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="flex flex-col gap-3">
                      <Button className="w-full group" asChild>
                        <a href="https://github.com/drylikov/accessly/releases/download/v1.0.0/chrome-mv3-dev.zip" target="_blank" rel="noopener noreferrer">
                          <Download className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform" />
                          Download Plugin
                        </a>
                      </Button>
                      <Button variant="outline" className="w-full group" asChild>
                        <a href="https://github.com/drylikov/accessly-plugin" target="_blank" rel="noopener noreferrer">
                          <Github className="w-4 h-4 mr-2 group-hover:rotate-12 transition-transform" />
                          Plugin Repository
                        </a>
                      </Button>
